...
(function (z) {
    ...
    var Wb = function () {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && !z.Ab("Presto") && (a = function () {
            ...
            a.write("");
            a.close();
            var c = "callImmediate" + Math.random(), d = "file:" == b.location.protocol ? "*" : b.location.protocol + "//" + b.location.host, a = (0, z.q)(function (a) {
                if (("*" ==
    ...
    var xe = function (a) {
        ...
        a.oh = b;
        d && (k = (0, z.q)(a.gE, a, !0), d = (0, z.q)(a.gE, a, !1), b instanceof ve ? (ze(b, k, d), b.gN = !0) : b.then(k, d));
    ...
    var yf = function (a) {
        var b = {}, c = b.document || window.document, d = window.document.createElement("SCRIPT"), f = {
            DJ: d,
            hq: void 0
        }, g = new ve(zf, f), h = null, k = null != b.timeout ? b.timeout : 5E3;
    ...
    var Ti = function (a) {
        var b = a.replace(/^zhihu/, "intent") + "/#Intent;scheme\x3dzhihu;package\x3dcom.zhihu.android;end", c = window.navigator.userAgent.match(/Chrome\/(\d+)/);
    ...
    var Ik = function (a) {
        ...
        a.De(b, a.nT);
        a.Ss(b);
        var c = (0, window.$)('input[name\x3d"account"]', b), d = (0, window.$)('input[name\x3d"verification_code"]', b), f = (0, window.$)(".send-code", b);
    ...
    var Nk = function (a) {
        ...
        var b = {
            ...
            wechat: "微信",
            wechat_mp: "微信"
        }[a.wh.type], c = z.Ka("该%s曾绑定过以下知乎帐号", b), b = z.Ka("不绑定，用%s创建新帐号", b);
    ...
    var fd = "closure_lm_" + (1E6 * Math.random() | 0), od = {}, id = 0, rd = "__closure_events_fn_" + (1E9 * Math.random() >>> 0);
    z.x(z.G, z.xc);
    z.G.prototype[Wc] = !0;
    z.e = z.G.prototype;
    z.e.ji = function () {
    ...
    z.e.Rk = function (a, b, c) {
        ...
        z.Yg(a, this);
        z.xb(this.Qc, b, 0, a);
        a.wa && this.wa && a.getParent() == this ? (c = this.S(), b = c.childNodes[b] || null, b != a.m() && c.insertBefore(a.m(), b)) : c ? (this.h || this.B(), b = z.ah(this, b + 1), a.Ap(this.S(), b ? b.h : null)) : this.wa && !a.wa && a.h && a.h.parentNode && 1 == a.h.parentNode.nodeType && a.C()
    };
    z.e.S = function () {
        return this.h
    };
    ...
    var si = /^(\d{4})(?:(?:-?(\d{2})(?:-?(\d{2}))?)|(?:-?(\d{3}))|(?:-?W(\d{2})(?:-?([1-7]))?))?$/, ui = /^(\d{2})(?::?(\d{2})(?::?(\d{2})(\.\d+)?)?)?$/, ti = /Z|(?:([-+])(\d{2})(?::?(\d{2}))?)$/;
    Sh.prototype.iq = function (a) {
        var b = Math.min(this.Ud, this.Ld, this.Ed, this.od, this.rd, this.vd), c = Math.max(this.Ud, this.Ld, this.Ed, this.od, this.rd, this.vd);
    ...
    z.e.OA = function () {
        ...
        var a = this.K().ua(), b = z.Oe(z.Re(a) || window), c = Math.max(b.width, Math.max(a.body.scrollWidth, a.documentElement.scrollWidth)), a = Math.max(b.height, Math.max(a.body.scrollHeight, a.documentElement.scrollHeight));
    ...
    z.e.ha = function () {
        ...
        var d = z.Hg(this.m()), b = z.Oe(b), a = Math.max(a + b.width / 2 - d.width / 2, 0), c = Math.max(c + b.height / 2 - d.height / 2, 0);
        z.zg(this.m(), a, c);
        z.zg(this.Pe, a, c)
    };
    z.e.fp = function (a) {
    ...
    z.e.DV = function () {
        var a = this.K().ua(), b = z.Oe(z.Re(a) || window), c = Math.max(a.body.scrollWidth, b.width), a = Math.max(a.body.scrollHeight, b.height), d = z.Hg(this.m());
    ...
    z.e.mR = z.Qj(function () {
        var a = z.Ug(), b = a / 2, a = z.Ka("html.modal-open {overflow:hidden}html.modal-doc-overflow {margin-right:%spx}html.modal-doc-overflow .modal-translate-shifting.sticky {transition-property:none; transform:translateX(-%spx)}html.modal-doc-overflow .modal-shifting {position:relative; right:%spx}", a, b, b);
        z.Lg(a)
    });
    z.e.vm = z.aa(25);
    z.e.ha = function () {
        if (!this.cm || !window.Modernizr.flexbox)if (z.V.o.ha.call(this), !this.oF) {
            ...
            if (!z.Uj || z.Vj)var c = (0, window.parseInt)(a.css("top").slice(0, -2)), b = "-\x3d" + Math.min(c - b, 60) + "px";
    ...
    z.e.ia = function (a, b) {
        ...
        var c = (0, window.$)(".title", this.Se).addClass("right"), d = (0, window.$)(".view", this.Oc).addClass("right");
    ...
    z.Xm = {
        ...
        showErrors: function (a, b) {
            ...
            b.length && window.$.each(b, function (a, b) {
                var c = (0, window.$)(b.element), k = b.message, m = (0, window.$)('\x3clabel class\x3d"error"\x3e' + k + "\x3c/label\x3e");
    ...
    var pl;
    z.x(il, z.G);
    var jl = [27, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 19], kl = "color date datetime datetime-local email month number password search tel text time url week".split(" ");
    z.e = il.prototype;
    z.e.GU = function (a, b) {
